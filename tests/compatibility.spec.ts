...
const VERIFIED = new Set(['0.1.2-alpha.4', '0.1.2-rc.1', '0.1.7-alpha.2'])
...
describe('DSH forward compatibility policy', () => {
  ...
  it('pins optional DSH peers to the compatible alpha2 release', () => {
    ...
    expect(manifest.dsh?.compatibility?.dshReleases?.['0.1.7-alpha.2']).toBe('compatible')
  })
})
