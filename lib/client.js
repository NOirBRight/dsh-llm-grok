window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+..+..+..+.dsh-lab+tmp+dsh-llm-providers-ui-0.1.12-preview._a5ec5e7929e3b726f886dbaf39293108/node_modules/dsh-llm-providers-ui/lib/usage-readers.js
		...
		*/
		...
		function windowLabel(id, period) {
			return nonEmptyString$2(period) ? period : id;
		}
		...
		function decodePercentUsage(usage) {
			if (!nonEmptyString$2(usage.fetchedAt) || !Array.isArray(usage.windows) || usage.windows.length === 0) return void 0;
			const viewReset = usage.resetsAt;
			if (viewReset !== void 0 && !nonEmptyString$2(viewReset)) return void 0;
			const windows = [];
			for (const value of usage.windows) {
				const item = recordUsageValue$1(value);
				if (item === void 0 || !nonEmptyString$2(item.id) || !nonNegativeNumber$1(item.used) || !nonNegativeNumber$1(item.limit)) return void 0;
				if (item.period !== void 0 && !nonEmptyString$2(item.period)) return void 0;
				if (item.unit !== void 0 && item.unit !== "percent") return void 0;
				if (item.resetsAt !== void 0 && !nonEmptyString$2(item.resetsAt)) return void 0;
		...
		*/
		...
		function cachedSummary$1(value) {
			const item = recordUsageValue$1(value);
			if (item === void 0 || !nonEmptyString$2(item.providerKey) || !nonEmptyString$2(item.name)) return void 0;
			...
			for (const windowValue of item.windows) {
				...
				if (quotaWindow === void 0 || !nonEmptyString$2(quotaWindow.id) || !nonEmptyString$2(quotaWindow.label) || !nonEmptyString$2(quotaWindow.shortLabel) || !nonEmptyString$2(quotaWindow.valueText)) return void 0;
				...
				if (quotaWindow.resetsAt !== void 0 && !nonEmptyString$2(quotaWindow.resetsAt)) return void 0;
				windows.push({
					id: quotaWindow.id,
			...
			return {
				...
				status,
				windows,
				...nonEmptyString$2(item.fetchedAt) ? { fetchedAt: item.fetchedAt } : {}
			};
		}
		...
		function dropPersistedUsageKeys$1(keys) {
			...
			const kept = parsed.filter((value) => {
				const item = recordUsageValue$1(value);
				return item === void 0 || !nonEmptyString$2(item.providerKey) || !drop.has(item.providerKey);
			});
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+..+..+..+.dsh-lab+tmp+dsh-llm-providers-ui-0.1.12-preview._a5ec5e7929e3b726f886dbaf39293108/node_modules/dsh-llm-providers-ui/lib/provider-ui.js
		/** Plain-object guard shared by the reader factories and the sidebar cache validator. */
		...
		function formatRemainingDuration$1(ms) {
		...
		function parseResetTime$1(resetsAt) {
		...
		function formatResetInstant$1(resetsAt) {
			if (!nonEmptyString$1(resetsAt)) return void 0;
			const time = parseResetTime$1(resetsAt);
			...
			return {
				...
				overdue: delta <= 0,
				relative: formatRemainingDuration$1(delta)
			};
		}
		...
		*/
		...
		function headerQuotaFromCache(summary) {
			...
			const instant = formatResetInstant$1(quotaWindow.resetsAt);
		...
		*/
		function normalizeQuotaRemaining$1(input) {
		...
		*/
		...
		const meterWrapStyle$1 = {
			display: "flex",
			flexDirection: "column",
			gap: 5,
			minWidth: 0
		};
		const meterTopStyle$1 = {
			display: "flex",
			alignItems: "baseline",
			justifyContent: "space-between",
			gap: 8
		};
		const meterLabelStyle$1 = {
			minWidth: 0,
			overflow: "hidden",
		...
		const meterWarnFill$1 = { background: "var(--dsw-alias-state-warn-primary)" };
		const meterDetailStyle$1 = {
			color: "var(--dsw-alias-label-tertiary)",
			fontSize: 11,
			lineHeight: "16px"
		};
		const meterMissingStyle$1 = {
			color: "var(--dsw-alias-label-tertiary)",
			fontSize: 12,
			lineHeight: "18px"
		};
		/** Segmented remaining-quota meter. Unavailable quota renders a placeholder, never a zero bar. */
		function ProviderQuotaMeter$1(props) {
			const remaining = normalizeQuotaRemaining$1(props);
			const label = props.label ?? "Quota";
			if (remaining === void 0) return (0, react_jsx_runtime.jsx)("span", {
				"data-provider-quota-missing": "",
				style: meterMissingStyle$1,
			...
			return (0, react_jsx_runtime.jsxs)("span", {
				"data-provider-quota": "",
				style: meterWrapStyle$1,
				...props.id === void 0 ? {} : { id: props.id },
				children: [
					(0, react_jsx_runtime.jsxs)("span", {
						style: meterTopStyle$1,
						children: [(0, react_jsx_runtime.jsx)("span", {
							style: meterLabelStyle$1,
							children: label
						}), (0, react_jsx_runtime.jsx)("span", {
							style: meterValueStyle$1,
							children: text + "%"
						})]
					}),
					(0, react_jsx_runtime.jsxs)("span", {
						...
						style: meterTrackStyle$1,
						children: [(0, react_jsx_runtime.jsx)("span", {
							style: {
								...meterFillBase$1,
								...warn ? meterWarnFill$1 : {},
								width: text + "%"
							},
							children: (0, react_jsx_runtime.jsx)("span", { style: meterKnobStyle$1 })
						}), (0, react_jsx_runtime.jsx)("span", {
							"aria-hidden": "true",
							style: meterSegmentsStyle$1
						})]
					}),
					props.detail === void 0 ? null : (0, react_jsx_runtime.jsx)("span", {
						style: meterDetailStyle$1,
		...
		const headerBadgeLlm$1 = {
			color: "var(--dsw-alias-label-secondary)",
			borderColor: "var(--dsw-alias-border-l2)",
			background: "transparent"
		};
		const headerBadgeAgent$1 = {
		...
		*/
		function ProviderRoleBadge$1(props) {
			const agent = (props.role ?? "llm") === "agent";
			return (0, react_jsx_runtime.jsxs)("span", {
				"data-provider-role-badge": agent ? "agent" : "llm",
				style: {
					...headerBadgeBase$1,
					...agent ? headerBadgeAgent$1 : headerBadgeLlm$1
				},
			...
			return (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [
					(0, react_jsx_runtime.jsxs)("span", {
						...
						children: [(0, react_jsx_runtime.jsx)("span", {
							...
							children: [(0, react_jsx_runtime.jsxs)("span", {
								...
								children: [(0, react_jsx_runtime.jsx)("span", { children: props.title }), (0, react_jsx_runtime.jsx)(ProviderRoleBadge$1, { ...props.role === void 0 ? {} : { role: props.role } })]
							}), (0, react_jsx_runtime.jsx)("span", {
					...
					quota === void 0 ? null : (0, react_jsx_runtime.jsx)("span", {
						...
						children: (0, react_jsx_runtime.jsx)(ProviderQuotaMeter$1, { ...quota })
					}),
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+..+..+..+.dsh-lab+tmp+dsh-llm-providers-ui-0.1.12-preview._a5ec5e7929e3b726f886dbaf39293108/node_modules/dsh-llm-providers-ui/lib/sortable.js
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+..+..+..+.dsh-lab+tmp+dsh-llm-providers-ui-0.1.12-preview._a5ec5e7929e3b726f886dbaf39293108/node_modules/dsh-llm-providers-ui/lib/provider-detail.js
		/** Non-empty string guard shared by the reader factories and the sidebar cache validator. */
		...
		*/
		function ProviderDetail(props) {
			...
			return (0, react_jsx_runtime.jsxs)("article", {
				...
				children: [
					(0, react_jsx_runtime.jsx)("style", { children: settingsCCss }),
					(0, react_jsx_runtime.jsx)("div", {
						...
						children: [
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [(0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										props.models.onToggleAll === void 0 ? null : (0, react_jsx_runtime.jsx)("button", {
											type: "button",
											className: "c-btn quiet",
										...
										props.models.onToggleSorting === void 0 ? null : (0, react_jsx_runtime.jsx)("button", {
											type: "button",
											className: "c-btn quiet",
										...
										props.models.onChooseFromAccount === void 0 ? null : (0, react_jsx_runtime.jsx)("button", {
											type: "button",
											className: "c-btn",
					...
					props.advanced === void 0 ? null : (0, react_jsx_runtime.jsxs)("details", {
						...
						children: [(0, react_jsx_runtime.jsxs)("summary", { children: [(0, react_jsx_runtime.jsx)("span", { children: props.copy.advancedHeading }), (0, react_jsx_runtime.jsx)("span", {
		...
		function UsageBar({ usedText, window: quota, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProviderQuotaMeter$1, {
				remainingPercent: remaining,
				label,
				...detail === void 0 ? {} : { detail }
			});
		...
		function GrokPluginCard(props) {
			...
			const capabilitiesSection = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				style: sectionStyle,
			...
			if (props.mode === "detail") {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
					...
					"data-provider-card": "",
					"data-provider-role": "llm",
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProviderDetail, {
