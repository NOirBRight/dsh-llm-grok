window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region node_modules/dsh-llm-providers-ui/lib/usage-readers.js
		...
		*/
		...
		//#endregion
		//#region node_modules/dsh-llm-providers-ui/lib/provider-ui.js
		/** Plain-object guard shared by the reader factories and the sidebar cache validator. */
		...
		*/
		...
		//#endregion
		//#region node_modules/dsh-llm-providers-ui/lib/sortable.js
		...
		*/
		...
		function GrokPluginCard(props) {
			...
			const quotaProps = headerQuota === null ? auth.kind === "signed-in" && (usage.status === "error" || usage.status === "unsupported") ? { quota: { label: t("usage") } } : {} : { quota: headerQuota };
