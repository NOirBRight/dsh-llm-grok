window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		let dsh_llm_providers_ui_provider_detail = require("dsh-llm-providers-ui/provider-detail");
		...
		function GrokPluginCard(props) {
			...
			if (props.mode === "detail") {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
					...
					"data-provider-card": "",
					"data-provider-role": "llm",
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(dsh_llm_providers_ui_provider_detail.ProviderDetail, {
						name: USAGE_PROVIDER_NAME,
						role: "llm",
						copy: props.copy ?? dsh_llm_providers_ui_provider_detail.providerDetailCopy.en,
