window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_00f3812da589a9d0a5c7bb7273dd5e32/node_modules/dsh-llm-providers-ui/lib/usage-readers.js
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_00f3812da589a9d0a5c7bb7273dd5e32/node_modules/dsh-llm-providers-ui/lib/provider-ui.js
		/**
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_00f3812da589a9d0a5c7bb7273dd5e32/node_modules/dsh-llm-providers-ui/lib/sortable.js
		...
		*/
		...
		function GrokPluginCard(props) {
			...
			(0, react.useEffect)(() => {
				...
				auth.kind,
				liveQuota?.remainingPercent,
				liveQuota?.label
			]);
			const usageAnswered = usage.status === "ready" || lastUsage !== void 0;
			const headerQuota = liveQuota ?? (auth.kind === "signed-in" && !usageAnswered ? headerQuotaFromCache(peekCachedUsage(USAGE_PROVIDER_KEY)) ?? null : null);
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProviderCardHeader, {
							...
							role: "llm",
							...headerQuota === null ? auth.kind === "signed-in" && (usage.status === "error" || usage.status === "unsupported") ? { quota: { label: t("usage") } } : {} : { quota: headerQuota }
						})
					}),
