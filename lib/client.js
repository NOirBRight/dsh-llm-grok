window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region ../dsh-providers-settings-a/lib/usage-readers.js
		...
		*/
		...
		//#endregion
		//#region ../dsh-providers-settings-a/lib/provider-ui.js
		/**
		...
		*/
		...
		//#endregion
		//#region ../dsh-providers-settings-a/lib/sortable.js
		...
		*/
		...
		function GrokPluginCard(props) {
			...
			const headerQuota = auth.kind === "signed-out" || auth.kind === "signing-in" || usage.status === "error" || usage.status === "unsupported" ? void 0 : liveQuota ?? headerQuotaFromCache(peekCachedUsage("llm-grok"));
