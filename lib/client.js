window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_4ed239280b973dbb3bca849c3b4e1a48/node_modules/dsh-llm-providers-ui/lib/usage-readers.js
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_4ed239280b973dbb3bca849c3b4e1a48/node_modules/dsh-llm-providers-ui/lib/provider-ui.js
		/** Plain-object guard shared by the reader factories and the sidebar cache validator. */
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_4ed239280b973dbb3bca849c3b4e1a48/node_modules/dsh-llm-providers-ui/lib/sortable.js
		...
		*/
		...
		function apply(ctx) {
			...
			const settingsForm = ctx.configForms.get(GROK_SETTINGS_NAMESPACE);
			const callGrokRpc = (endpoint, payload, signal) => rpc.call("/api", GROK_RPC_METHOD, {
				endpoint,
				payload
			}, signal);
			...
			const publishAccount = (state) => {
				...
				account.state = state;
				try {
					ctx.get("providerDirectory")?.update(GROK_SETTINGS_NAMESPACE);
				} catch {}
			};
			...
			const completeAuth = async (code, attemptId) => {
				const result = await callGrokRpc(GROK_AUTH_COMPLETE_ENDPOINT, {
					code,
					...attemptId === void 0 ? {} : { attemptId }
				});
				if (!result.ok) return {
			...
			const saveConfiguration = async (settings, expectedRevision) => {
				...
				}], expectedRevision)) throw new Error(t("requestFailed"));
				const snapshot = settingsForm.getSnapshot();
				if (snapshot.value === void 0 || snapshot.revision === void 0) throw new Error(t("requestFailed"));
				return {
