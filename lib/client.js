window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region ../dsh-llm-providers-ui/src/client/nav-icon.ts
		/** Official 14px globe glyph on the LLM Providers nav row. */
		...
		/** Use the official globe glyph on the LLM Providers nav row. */
		...
		//#endregion
		//#region ../dsh-llm-providers-ui/src/order.ts
		...
		*/
		...
		//#endregion
		//#region ../dsh-llm-providers-ui/src/client/SortableList.tsx
		...
		*/
		...
		//#endregion
		//#region ../dsh-llm-providers-ui/src/client/ProvidersSection.tsx
		...
		function bindProvidersSection(listRegisteredKeys, subscribe, readOrder, onReorder) {
			return function BoundProvidersSection(props) {
				...
				const next = { registeredKeys: listRegisteredKeys() };
				if (props.renderSlot !== void 0) next.renderSlot = props.renderSlot;
				if (props.t !== void 0) next.t = props.t;
				if (order !== void 0) {
					next.savedOrder = order.keys;
					next.disabled = order.disabled;
				}
				if (onReorder !== void 0) next.onReorder = onReorder;
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProvidersSection, { ...next });
			};
		}
		...
		function ProvidersSection(props) {
			...
			const renderCard = (item) => {
				...
				return node == null ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react.Fragment, { children: node });
			};
			const body = keys.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
				style: emptyStyle,
				children: t("empty")
			}) : keys.length < 2 || props.disabled === true ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				style: listStyle$1,
				children: items.map((item) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react.Fragment, { children: renderCard(item) }, item.key))
			}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SortableList, {
				chrome: "card",
				items,
				getId: (item) => item.key,
		...
		//#endregion
		//#region ../dsh-llm-providers-ui/src/client/provider-section.ts
		const copy = {
			zh: {
				nav: "LLM 供应商",
				title: "LLM 供应商",
		...
		function bindOrder(ctx) {
			...
			if (!isSettingsScopeFace(value)) return void 0;
			try {
				return value.bind({
			...
			slots.inject("settings.section", () => {
				...
				const claim = () => {
					...
					try {
						disposeSection = slots.register({
						...
						}, bindProvidersSection(() => slots.entries(PROVIDERS_ITEM_SLOT).map((entry) => entry.options.key).filter((key) => typeof key === "string" && key.length > 0), (listener) => {
							...
							return {
								...
								disabled: snapshot !== void 0 && (snapshot.status !== "ready" || snapshot.writable !== true)
							};
						}, (keys) => {
