...
function parseCliBillingConfig(value, fetchedAt) {
	...
	if (onDemand !== void 0 && onDemand > 0) windows.push({
		id: "on-demand",
		used: 0,
		limit: onDemand
	});
