...
function decodeGrokEmptyRequest(value) {
	...
	if (!isRecord$2(value) || hasTokenFields(value)) return void 0;
	return {};
}
/**
...
function decodeGrokAuthStartReply(value) {
	if (!isRecord$2(value) || hasTokenFields(value) || typeof value["ok"] !== "boolean") return void 0;
...
function decodeGrokAuthStatus(value) {
	if (!isRecord$2(value) || hasTokenFields(value) || typeof value["loggedIn"] !== "boolean") return void 0;
...
function decodeGrokAuthLogoutReply(value) {
	if (!isRecord$2(value) || hasTokenFields(value) || value["ok"] !== true) return void 0;
	return { ok: true };
}
//#endregion
...
//#endregion
export { Config, GROK_AUTH_LOGOUT_ENDPOINT, GROK_AUTH_START_ENDPOINT, GROK_AUTH_STATUS_ENDPOINT, GROK_CATALOG, GROK_DEFAULT_STREAM_IDLE_TIMEOUT_MS, GROK_OAUTH_CLIENT_ID, GROK_OAUTH_ISSUER, GROK_OAUTH_SCOPE, GROK_PROVIDER, GROK_RPC_CHANNEL, GROK_SESSION_FILENAME, GROK_SETTINGS_NAMESPACE, apply, createGrokAuthRuntime, createGrokRpcHandler, decodeGrokAuthLogoutReply, decodeGrokAuthStartReply, decodeGrokAuthStatus, decodeGrokEmptyRequest, decodeGrokSettings, deleteSession, ensureFreshSession, inject, name, readSession, refreshSession, resolveGrokSessionPath, sessionPathForHome, startPkceLogin, statusFromSession, writeSession };
