...
function decodeGrokAuthStartReply(value) {
	if (!isRecord$6(value) || hasTokenFields(value) || typeof value["ok"] !== "boolean") return void 0;
...
function decodeGrokAuthStatus(value) {
	if (!isRecord$6(value) || hasTokenFields(value) || typeof value["loggedIn"] !== "boolean") return void 0;
...
function decodeGrokAuthLogoutReply(value) {
	if (!isRecord$6(value) || hasTokenFields(value) || value["ok"] !== true) return void 0;
	return { ok: true };
}
...
function decodeGrokModelsReply(value) {
	if (!isRecord$6(value) || hasTokenFields(value) || !Array.isArray(value["models"])) return void 0;
	const models = [];
...
function applyGrokReasoningWire(payload, model) {
	if (!isRecord$5(payload) || model.thinking !== true) return payload;
	const effort = resolveGrokReasoningWire((isRecord$5(payload["reasoning"]) ? payload["reasoning"] : void 0)?.["effort"], model);
	return {
		...payload,
		reasoning: { effort }
	};
	...
	return (model, context, options) => {
		...
		return streamFn(model, context, {
			...
			onPayload: async (payload, nextModel) => {
				...
				return applyGrokReasoningWire(injectGrokServerSearchTools(next === void 0 ? payload : next), catalogFor(nextModel, models));
			}
		});
	};
}
...
function grokResponsesApi(models = []) {
	...
	return {
		stream: withGrokResponsesBody(base.stream, models),
		streamSimple: withGrokResponsesBody(base.streamSimple, models)
	};
}
//#endregion
