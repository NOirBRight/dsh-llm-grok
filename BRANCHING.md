...
|---|---|
| 稳定分支 | `main` |
| 当前稳定版（用户安装 / 回滚首选） | `v0.3.12-015rc1b` |
| 上一稳定版（兜底回滚） | `v0.3.11` |
| 集成分支 | `dev` |
| dev HEAD | `d0a0abc chore: rebuild tracked bundle and fix merge seams (duplicate method, unused imports)` |

### 已折叠进 dev 的历史线

- feat/provider-settings-a (duplicate 0.3.12 line; keep the migrated implementation)
- feat/provider-reorder (duplicate release line; keep the migrated implementation)
- w4/review-fix (015 migration)
