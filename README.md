...
Open Settings → Plugins → Plugin configuration → Grok. The card currently shows a logged-out state, an inert sign-in control, and the frozen model catalog (`grok-4.6` with reasoning and vision). Sign-in, chat, and usage land in later tickets.
